...
{
  uint32_t a,b,c;
  union { const void *ptr; const uint8_t *c; const uint32_t *k; size_t i; } u;
  ...
  if (!HASH_LITTLE_ENDIAN && ((u.i & 0x3) == 0)) {
    ...
    {
    case 12: c+=k[2]; b+=k[1]; a+=k[0]; break;
    case 11: c+=((uint32_t)k8[10])<<8; __attribute__((fallthrough)); /* fall through */
    case 10: c+=((uint32_t)k8[9])<<16; __attribute__((fallthrough)); /* fall through */
    case 9 : c+=((uint32_t)k8[8])<<24; __attribute__((fallthrough)); /* fall through */
    case 8 : b+=k[1]; a+=k[0]; break;
    case 7 : b+=((uint32_t)k8[6])<<8; __attribute__((fallthrough)); /* fall through */
    case 6 : b+=((uint32_t)k8[5])<<16; __attribute__((fallthrough)); /* fall through */
    case 5 : b+=((uint32_t)k8[4])<<24; __attribute__((fallthrough)); /* fall through */
    case 4 : a+=k[0]; break;
    case 3 : a+=((uint32_t)k8[2])<<8; __attribute__((fallthrough)); /* fall through */
    case 2 : a+=((uint32_t)k8[1])<<16; __attribute__((fallthrough)); /* fall through */
